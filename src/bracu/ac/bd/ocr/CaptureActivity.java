...
import bracu.ac.bd.ocr.camera.CameraManager;
import bracu.ac.bd.ocr.camera.ShutterButton;
import bracu.ac.bd.ocr.language.LanguageCodeHelper;
import bracu.ac.bd.ocr.language.TranslateAsyncTask;
...
public final class CaptureActivity extends Activity implements
	...
	void onShutterButtonPressContinuous() {
		...
		if (lastResult != null) {
			...
			Toast toast = Toast.makeText(this, "Recognition Failed!",
					Toast.LENGTH_SHORT);
	...
	public void myMenuMethod(View v) {
		openOptionsMenu();
	}
